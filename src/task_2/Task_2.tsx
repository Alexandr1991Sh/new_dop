...
// Если щелкнуть по компоненту «Кнопка», флажок не будет перерисовываться
// Если щелкнуть компонент Checkbox, кнопка не будет перерисовываться

export const Task_2 = memo(() => {
